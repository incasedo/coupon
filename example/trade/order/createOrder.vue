<template>
	<view>
		...
		<view class="address-section" @click="addAddress()">
			<view class="order-content">
				...
				<view class="cen" v-if="addressData.id">
					...
					<text class="address">{{addressData.location}}
					<block v-if="addressData.address">({{addressData.address}})</block>
		...
		<view class="yt-list">
			...
			<view class="yt-list-cell b-b" v-if="couponMoney">
				<text class="cell-tit clamp">优惠金额</text>
				<text class="cell-tip red">-￥{{couponMoney}}</text>
			</view>
			<view class="yt-list-cell b-b">
